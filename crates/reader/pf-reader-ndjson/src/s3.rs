//! S3 client wrapper for NDJSON reader.
//!
//! This is largely duplicated from pf-reader-parquet. In a production codebase,
//! this would be refactored into a shared crate.
